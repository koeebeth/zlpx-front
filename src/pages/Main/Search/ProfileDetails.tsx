...
export const ProfileDetails: FC<PropsT> = ({ user }) => {
  return (
    <div className="flex flex-col gap-2 p-2 bg-zinc-300 flex-1 dark:bg-zinc-900 overflow-scroll">
      <div className="rounded-lg bg-zinc-400 dark:bg-zinc-800 flex items-center justify-between p-6">
        <div>
      ...
      <div className="rounded-lg bg-zinc-400 dark:bg-zinc-800 p-6">
